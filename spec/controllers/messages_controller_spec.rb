...
describe MessagesController do
  ...
  describe 'GET #index' do
    ...
    def build_current_group
      build(:chat_group, id: chat_group.id)
    end
  ...
  describe 'POST #create' do
    ...
    context 'success to save' do
      it 'save success' do
        ...
        expect { post :create, create_success_params }.to change(Message, :count).by(1)
        end
    ...
    context 'fail to save' do
      it 'can not save in the database' do
        ...
        expect{ post :create, create_fail_params }.not_to change(Message, :count)
        end
